...
// HealthProvider implements the health feature provider.
...
func (p *HealthProvider) Version() string        { return "1.0.6" }
func (p *HealthProvider) Features() []string     { return []string{"health"} }
